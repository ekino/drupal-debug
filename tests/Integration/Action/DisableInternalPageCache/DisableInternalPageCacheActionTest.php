...
class DisableInternalPageCacheActionTest extends AbstractActionTestCase
{
     ...
     * @var string
     */
    private const MODULE_CONTROLLER_FILE_PATH = __DIR__.'/fixtures/modules/hit_page_cache/src/Controller/__FooController.php';
    ...
    protected function doTestInitialBehaviorWithDrupalKernel(Client $client): void
    {
        ...
        $this->assertContains('How many people rise and say', $results[0]);

        $this->assertContains('How many people rise and say', $results[1]);
        $this->assertNotContains('And I suspect you feel the same', $results[1]);
    }
    ...
    protected function doTestTargetedBehaviorWithDebugKernel(Client $client): void
    {
        ...
        $this->assertContains('And I suspect you feel the same', $results[1]);
        $this->assertNotContains('How many people rise and say', $results[1]);
    }
