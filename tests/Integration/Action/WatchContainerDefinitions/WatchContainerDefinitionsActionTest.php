...
namespace Ekino\Drupal\Debug\Tests\Integration\Action\WatchContainerDefinitions;
...
class WatchContainerDefinitionsActionTest extends AbstractActionTestCase
{
    use FileHelperTrait;
